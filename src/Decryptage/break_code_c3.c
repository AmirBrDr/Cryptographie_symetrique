...
int main(int argc, char *argv[]){
    ...
    size_t taille;
    char *nom_fichier = "long_texte.txt"; //temporaire, la fonction finale prendra en paramètre le même fichier que breakc1
    ...
    size_t taille_dico;
    char *nom_dico = "dicoFrSA.txt"; //temporaire, doit être pris en variable
